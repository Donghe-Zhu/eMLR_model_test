...
ggplot() + 
  geom_raster(data = nc_data_tibble_regrided,
  ...
  labs(title = "Observation and Model Data Distribution", subtitle = "Depth: 5m | Month: August", x = "Longitude", y = "Latitude", colour = "DIC [mmol/m3]") 
