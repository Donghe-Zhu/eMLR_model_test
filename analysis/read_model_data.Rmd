...
I want to get a tibble of DIC data, with labels of real latitude, longitude, depth, month and value (if not real latitude and longitude (grid sequence number), I also need to find how to link the real ones with the grid sequence number). But now I don't know how could I obtain the tibble with tidync.

Since I fail in the data extraction, I an sure that there is some errors following this one. But as long as I can read in the data, I can figure out the following code. 
...
```{r Map of surface DIC value, eval = FALSE}
ggplot() +
