...
nc_data_tibble_regrided <- nc_data_tibble_regrided %>%
  select(-time)
nc_data_tibble_regrided$lon <- round(nc_data_tibble_regrided$lon + 0.5) - 0.5
nc_data_tibble_regrided$lat <- round(nc_data_tibble_regrided$lat + 0.5) - 0.5
